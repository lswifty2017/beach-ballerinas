...
export function ImageContent({
  ...
  const imageStyles = {
    circle: "rounded-full w-[220px] h-[220px] tablet:w-[360px] tablet:h-[360px] desktop:w-[400px] desktop:h-[400px]",
  ...
  return (
    <section
      ...
      className={cn(
        "pt-0",
        `w-full tablet:pt-0"  ${imgType === 'square' ? "pt-12" : ""} `,
    ...
    >
      <div
        className={cn(
          ...
          "w-full",
          "tablet:flex tablet:items-center tablet:justify-center",
      ...
      >
        ...
        <div className="tablet:w-1/2 tablet:flex">
          <div className={cn(
            ...
            "text-center",
            "desktop:items-start desktop:text-left"
          )}>
            {children}
          </div>
        </div>
